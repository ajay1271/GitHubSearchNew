...
public class FollowingPojo implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<FollowingPojo> CREATOR = new Creator<FollowingPojo>() {


        @SuppressWarnings({
            "unchecked"
        })
        public FollowingPojo createFromParcel(Parcel in) {
            return new FollowingPojo(in);
        }

        public FollowingPojo[] newArray(int size) {
            return (new FollowingPojo[size]);
        }

    }
    ;
    private final static long serialVersionUID = 1811641768807658024L;

    protected FollowingPojo(Parcel in) {
