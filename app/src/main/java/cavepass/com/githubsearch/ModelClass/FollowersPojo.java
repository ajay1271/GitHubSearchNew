...
public class FollowersPojo implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<FollowersPojo> CREATOR = new Creator<FollowersPojo>() {


        @SuppressWarnings({
            "unchecked"
        })
        public FollowersPojo createFromParcel(Parcel in) {
            return new FollowersPojo(in);
        }

        public FollowersPojo[] newArray(int size) {
            return (new FollowersPojo[size]);
        }

    }
    ;
    private final static long serialVersionUID = 8340572792689532908L;

    protected FollowersPojo(Parcel in) {
